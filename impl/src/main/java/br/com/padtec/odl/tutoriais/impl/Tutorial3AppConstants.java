...
final class Tutorial3AppConstants {

    /*
     * define sample flow constants
     */
    private Tutorial3AppConstants(){

    }

    public static final String FLOWID_PREFIX = "tutorial";
    ...
    public static final BigInteger COOKIE_TUTORIAL2APP_BASE =
            new BigInteger("1000000",16);
