 ...
 */
package br.com.padtec.odl.tutoriais.cli.commands;
...
public class Tutorial3CliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(Tutorial3CliTestCommand.class);
    protected final Tutorial3CliCommands service;

    public Tutorial3CliTestCommand(final Tutorial3CliCommands service) {
